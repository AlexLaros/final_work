    ...
    def start(self):
        ...
        try:
            ...
            if len(notes_lst) == 0:
                ...
                elif len(notes_lst) % 10 == 2 or len(
                        notes_lst) % 10 == 3 or len(notes_lst) % 10 == 3 \
                ...
                for e in range(len(list_of_lst_notes[i][j])):
                    for s in range(len(signs)):
                        if list_of_lst_notes[i][j][e] == signs[s]:
                            list_of_lst_notes[i][j] = list_of_lst_notes[i][
                                j].replace(signs[s], ' ')
        ...
        while True:
            try:
                ...
                if search_num_of_operation == 1:
                    ...
                    file.close()
                    list_of_dict_notes = self.__list_of_str_to_list_of_dict(
                        list_of_notes)
                    while True:
                        try:
                            ...
                            try:
                                ...
                                if sort_by == 1:
                                    ...
                                    print("╔══════════╗\n"
                                          ...
                                          "╚══════════╝\n"
                                          "Здесь такой цифры нет!\n"
                                          "Доступные функциональные номера: 1 "
                                          "и 2")
                                    continue
